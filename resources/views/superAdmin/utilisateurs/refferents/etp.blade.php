    ...
    <div class="w-full h-full container mt-4">
        ...
        @else
            ...
            <div class="w-full p-4 rounded-3xl bg-white">
                ...
                <div class="mb-4">
                    <input type="text" id="searchInput" placeholder="Rechercher un référent d'entreprise..." class="w-full p-2 border rounded">
                </div>
                ...
                <table class="table table-hover caption-top">
                    <caption class="text-2xl font-medium text-slate-800">Liste des référents des entreprises
                    </caption>
                    <thead>
                        <tr>
                    ...
                    <tbody id="moduleTableBody">
                        @foreach ($referents as $referent)
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <a href="/superAdmins/referents/entreprise/delete/{{ $referent->id }}"><i class="fa-solid fa-trash-can" title="Supprimer définitivement"></i></a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
