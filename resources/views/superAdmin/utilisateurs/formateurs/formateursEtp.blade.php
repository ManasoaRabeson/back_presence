    ...
    <div class="w-full h-full container mt-4">
        ...
        @else
            ...
            <div class="w-full p-4 rounded-3xl bg-white">
                ...
                <div class="mb-4">
                    <input type="text" id="searchInput" placeholder="Rechercher un formateur interne..." class="w-full p-2 border rounded">
                </div>
                    ...
                    <tbody id="moduleTableBody">
                        @foreach ($formateurs as $formateur)
                            <tr>
                                ...
                                <td>
                                    <div>
                                        {{ $formateur->customer_addr_quartier }}
                                    </div>
                                </td>
                                <td>
                                    <div>
                                        <a href="/superAdmins/formateurs/etp/delete/{{ $formateur->idEmploye }}"><i class="fa-solid fa-trash-can" title="Supprimer définitivement"></i></a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
