...
@section('content')
    <div class="w-full h-full container mt-4">
        @if (count($modules) <= 0)
            <div>
                Aucun module de centre de formation professionnelle
            </div>
        @else
            {{-- Début tableau --}}
            <div class="w-full p-4 rounded-3xl bg-white">
                ...
                <table class="table table-hover caption-top">
                    <caption class="text-2xl font-medium text-slate-800">
                        Liste des modules de centre de formation professionnelle
                    </caption>
                    <thead>
                        <tr>
                        ...
                        @foreach ($modules as $module)
                            <tr>
                                ...
                                <td style="width: 100px;">
                                    <div>
                                        <a href="/superAdmins/modules/{{ $module->idModule }}"><i class="fa-solid fa-eye" title="Voir détail" style="margin-right: 15px"></i></a>
                                        <a href="/superAdmins/modules/cfp/delete/{{ $module->idModule }}"><i class="fa-solid fa-trash-can" title="Supprimer définitivement"></i></a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
