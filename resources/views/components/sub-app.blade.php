<div
  class="inline-flex items-center gap-3 bg-gray-50 w-[calc(100%-50px)] min-h-10 fixed top-[32px] z-10 px-2 rounded-md shadow-sm">
  {{-- puzzle-piece --}}
  ...
  <div class="inline-flex items-center gap-2">
    ...
    <label class="text-lg text-gray-00 font-semibold">{{ $label }}</label>
  </div>
  {{ $slot }}
</div>
