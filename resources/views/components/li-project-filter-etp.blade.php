                    ...
                    <div class="btn-group h-max">
                        ...
                        <ul class="dropdown-menu">
                            <x-dropdown-item icontype="solid" icon="eye" label="Aperçu"
                                route="/etp/projets/{{ $id }}/detail" />
                            <hr class="border-[1px] border-gray-400 my-2">
                            <x-dropdown-item icontype="solid" icon="check" type="btn"
                                onclick="showModalConfirmation({{ $id }}, 'Valider')"
                                label="Valider le projet" />
                            <x-dropdown-item icontype="solid" icon="trash" type="btn"
                                onclick="showModalConfirmation({{ $id }}, 'Supprimer')" label="Supprimer" />
                            <x-dropdown-item icontype="solid" icon="copy" type="btn"
                                onclick="showModalConfirmation({{ $id }}, 'Dupliquer')" label="Dupliquer" />

                            <hr class="border-[1px] border-gray-400 my-2">
                            <x-dropdown-item icontype="solid" icon="xmark" type="btn"
                                onclick="showModalConfirmation({{ $id }}, 'Annuler')" label="Annuler" />
                            <x-dropdown-item icontype="solid" icon="right-left" type="btn"
                                onclick="showModalConfirmation({{ $id }}, 'Reporter')" label="Reporter" />
                        </ul>
                    </div>
                </div>
                <div class="grid items-end justify-end col-span-1 p_note_{{ $id }}">
            ...
            <div class="grid col-span-12 grid-cols-subgrid">
                ...
                <div class="grid w-full grid-cols-6 pr-4">
                    ...
                    <div class="grid justify-end col-span-1">
                        <div class="inline-flex items-center gap-x-2 p_restauration_{{ $id }}"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid w-full col-span-12 grid-cols-subgrid">
                ...
                <div class="grid w-full grid-cols-3">
                    <div class="inline-flex items-center w-full">
                        ...
                        <p class="p_paiement_{{ $id }} font-medium text-gray-500">
                        </p>
                    </div>
                    ...
                    <div class="inline-flex items-center w-full">
                        ...
                        <span class="p_price_ht_{{ $id }} font-medium text-gray-500">
                        </span>
                    </div>
                    ...
                    <div class="btn-group h-max">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <x-dropdown-item icontype="solid" icon="check" type="btn"
                                ...
                                label="Valider le projet" />
                            <x-dropdown-item icontype="solid" icon="trash" type="btn"
                                onclick="showModalConfirmation({{ $id }}, 'Supprimer')"
                                label="Supprimer" />
                            <x-dropdown-item icontype="solid" icon="copy" type="btn"
                                onclick="showModalConfirmation({{ $id }}, 'Dupliquer')"
                                label="Dupliquer" />
