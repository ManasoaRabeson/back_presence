<div class="offcanvas offcanvas-end !w-[45em]" tabindex="-1" id="offcanvas5" aria-labelledby="offcanvas5">
    <div class="flex flex-col w-full">
        <div class="w-full px-4 py-2 inline-flex items-center justify-between bg-gray-100">
            <p class="text-lg text-gray-500 font-medium">Modifier vos langues</p>
        ...
        <div class="w-full overflow-x-auto p-4 overflow-y-auto h-[100vh] pb-3">
            <div class="flex flex-col gap-y-3">
                <div class="flex justify-between items-center">
                    <h1 class="text-xl font-semibold text-[#a462a4]">Ajouter mes langues</h1>
                </div>
                <!--Body-->
                <form action="{{ route('miniCv.index.store') }}" method="post">
                    ...
                    <div class="flex flex-col w-full gap-3">
                        <div class="flex flex-col w-full gap-1">
                            <x-input name="Langue" type="text" label="Insérer vos langues"
                                value="{{ old('Langue') }}" />
                        </div>
                    </div>
                    <!--Footer-->
