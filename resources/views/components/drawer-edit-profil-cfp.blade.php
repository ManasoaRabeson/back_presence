...
@endphp
<div class="offcanvas offcanvas-end !w-[45em]" tabindex="-1" id="offcanvasProfilCfp" aria-labelledby="offcanvas">
    <div class="flex flex-col w-full">
        <div class="w-full px-4 py-2 inline-flex items-center justify-between bg-gray-100">
            <p class="text-lg text-gray-500 font-medium">Modifier le profil du centre de formation</p>
            <a data-bs-toggle="offcanvas" href="#offcanvasProfilCfp" role="button" aria-controls="offcanvas"
        ...
        <div class="w-full overflow-x-auto p-4 overflow-y-auto h-[100vh] pb-3">
            <div class="flex flex-col gap-y-3">
                ...
                <x-input name="" type="tel" label="Téléphone 3" /> --}}
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <x-input name="customer_admin_cp_edit" type="number" label="Code postal" /> --}}
            ...
            <div class="w-full inline-flex items-end justify-end pt-3 mb-16 gap-2">
...
<div class="modal fade" id="cropProfile" tabindex="-1" role="dialog" data-bs-backdrop="static"
    ...
    <div class="modal-dialog du_modal-box w-full max-w-screen-xl" role="document">
        <div class="modal-content bg-white border-none justify-start h-full gap-2 rounded-md">
                    ...
                    <div class="row">
                        <div class="grid grid-cols-4 h-full">
                            <div class="grid col-span-3">
                                <img id="imageprofile" src="" class="!h-full !w-auto !object-cover">
                            </div>
            ...
            <div class="modal-footer">
                ...
                <x-btn-primary id="croped"
                    onclick="cropedCustomer(sessionStorage.getItem('ID_CROP_LOGO_CFP')) ">Recadrer
