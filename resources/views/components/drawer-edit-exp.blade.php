<div class="offcanvas offcanvas-end !w-[45em]" tabindex="-1" id="offcanvas2" aria-labelledby="offcanvas2">
  <div class="flex flex-col w-full">
    <div class="w-full px-4 py-2 inline-flex items-center justify-between bg-gray-100">
      <p class="text-lg text-gray-500 font-medium">Modifier vos expérience</p>
    ...
    <div class="w-full overflow-x-auto p-4 overflow-y-auto h-[100vh] pb-3">
      <div class="flex flex-col gap-y-3">
        ...
        <div class="flex justify-between items-center">
          <h1 class="text-xl font-semibold text-[#a462a4]">Ajouter une expérience</h1>
        </div>
        <!--Body-->
        <div class="my-2">
              ...
              <div class="flex flex-col gap-4">
                <div class="flex flex-row gap-4">
                  <div class="flex flex-col w-full gap-3">
                    <x-input name="Fonction" type="text" label="Intitulé du poste" value="{{ old('Fonction') }}" />
                  </div>
                  <div class="flex flex-col w-full gap-1">
                    <x-input name="Lieu_de_stage" type="text" label="Nom de l'entreprise"
                      value="{{ old('Lieu_de_stage') }}" />
                  </div>
                  <div class="flex flex-col w-full gap-1">
                    <x-input name="Lieu" type="text" label="Lieu" value="{{ old('Lieu') }}" />
                  </div>
                </div>
