        ...
        <div class="grid col-span-1 p-3">
          ...
          <div class="inline-flex items-center">
            ...
            <div class="inline-flex items-center gap-2">
              <p class="text-gray-500 font-medium">{{ $p['paiement'] }}</p>
            </div>
          </div> --}}
            </div>
        </div>
...
<x-modal-session onClick="manageProject('delete', '/cfp/projets/{{ $p['idProjet'] }}/destroy')"
    id="supprimerProjet{{ $p['idProjet'] }}_sm" icon="Animations/Delete.json" titre="Suppression"
...
<x-modal-session onClick="manageProject('patch', '/cfp/projets/{{ $p['idProjet'] }}/cancel')"
    id="annulerProjet{{ $p['idProjet'] }}_sm" icon="Animations/Delete.json" titre="Annuler"
    description="Voulez-vous vraiment annuler cette session ?" couleur="gray" />

<div class="modal fade" id="reporterProjet{{ $p['idProjet'] }}_sm" data-bs-backdrop="static"
