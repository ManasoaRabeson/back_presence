    ...
    <div class="flex flex-col items-center justify-center w-screen h-screen gap-12 py-8 ">
        <svg class="h-[50vh] aspect-video" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
            ...
            <g id="freepik--Character--inject-3">
                ...
                <path
                    ...
                    style="fill:#A462A4;stroke:#263238;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.166343341900884px">
                </path>
                <path
            ...
            <g id="freepik--security-barrier--inject-3">
                ...
                <rect x="55.73" y="293.21" width="271.93" height="26.36"
                    style="fill:#A462A4;stroke:#263238;stroke-miterlimit:10;stroke-width:1.166343341900884px"></rect>
        ...
        <div class="flex flex-col items-center gap-4">
            ...
            <p class="text-xl text-center ">
                Votre compte est désactivé, veuillez contactez votre responsable principale !
            </p>
            <a href="{{ url('login') }}" class="btn btn-outline"><i class="fa-solid fa-arrow-left"></i>Retour</a>
        </div>
    </div>
</body>
