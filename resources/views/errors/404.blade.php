    ...
    <div class="h-screen w-screen bg-gray-100 flex items-center">
        <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
            <div class="max-w-md">
                ...
                <p class="text-2xl md:text-3xl font-light leading-normal">Désolé, cette page est introuvable ! </p>
                {{-- <p class="mb-8">But dont worry, you can find plenty of other things on our homepage.</p> --}}

                <a href="javascript:history.back()"
                    class="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-[#A462A4] active:bg-[#A462A4] hover:bg-[#A462A4]">Revenir
                    en arrière</a>
            </div>
            <div class="max-w-lg">
